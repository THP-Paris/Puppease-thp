...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { dog_id: @wishlist.dog_id, limit: @wishlist.limit, user_id: @wishlist.user_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { dog_id: @wishlist.dog_id, limit: @wishlist.limit, user_id: @wishlist.user_id } }
