class Dog < ApplicationRecord
    ...
    Dalmatien:21, Samoyède:22, Rottweiler:23, "Shiba Inu":24, "Saint-Bernard":25, Dobermann:26, Croisé:27, Autre:28}

    enum color:  {Noir: 0, Blanc: 1, Marron: 2, Chocolat: 3, Beige: 4, Fauve: 5, Gris: 6, Bleu: 7}
